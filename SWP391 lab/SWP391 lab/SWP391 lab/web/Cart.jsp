                ...
                <div class="row">
                    ...
                    <aside class="col-lg-4" style="text-align: center; ">
                        <div class="summary summary-cart">
                            ...
                            <button onclick="location.href = 'CheckOut'" disabled id="check" style="width: 100%;border: none;background-color: #177BB6; color: white; padding: 20px 10px; border-radius: 5px;margin-top: 5px; font-size: 18px ">Check Out</button>
