...
public class ManagerPage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] orderPrice = {"Under 5.000.000 đ", "5.000.000đ - 10.000.000đ", "10.000.000đ - 20.000.000đ", "20.000.000đ & Above"};
        String[] orderStatus = {"To Confirm", "To Ship", "To Receive", "Completed", "Cancelled", "Return"};
