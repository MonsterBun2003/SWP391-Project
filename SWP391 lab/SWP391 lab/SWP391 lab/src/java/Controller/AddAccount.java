...
public class AddAccount extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (cus.getCusName(name) != null || admin.getAccByName(name) != null) {
            request.setAttribute("err", "This name is used !!!");
        } else if (cus.getCusEmail(email) != null || admin.getAccByEmail(email) != null) {
            request.setAttribute("err", "This email is used !!!");
        } else {
            if (account.equals("customer")) {
                request.setAttribute("success", "Added Successful !!!");
            ...
            try {
                ...
                ec.SendEmail(email, "Your Account Password " + pass + ". Please change password after login to website");
