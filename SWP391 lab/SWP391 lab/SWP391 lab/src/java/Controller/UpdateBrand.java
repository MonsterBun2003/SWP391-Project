                ...
                if (!request.getParameter("id").isEmpty()) {
                    ...
                    if (!name.trim().isEmpty()) {
                        ...
                        if (brand == null) {
                            ...
                            request.setAttribute("succ", "Add Successful !!!");
                        } else {

                            request.setAttribute("err1", "Can't add brand duplicate name!");
                        }

                    }
                }
            } else {
                request.setAttribute("err", "This file is invalid. Please Upload Images File");
            }
        } else {
