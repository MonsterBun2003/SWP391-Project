...
public class ManagerExport extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        cell.setCellValue((String) "All Completed Order:" + month + "-" + year);
        rowNum += 1;
        row = sheet.createRow(rowNum++);
        colNum = 1;
        cell = row.createCell(colNum++);
        cell.setCellValue((String) "Order Id");
        cell = row.createCell(colNum++);
        cell.setCellValue((String) "Customer Id");
        cell = row.createCell(colNum++);
        cell.setCellValue((String) "OrderDate");
        cell = row.createCell(colNum++);
        cell.setCellValue((String) "Total Price");
        cell = row.createCell(colNum++);
        cell.setCellValue((String) "Payment Method");
        for (Order ord : or) {
            row = sheet.createRow(rowNum++);
            colNum = 1;
            cell = row.createCell(colNum++);
        ...
        colNum = 1;
        cell = row.createCell(colNum++);
        cell.setCellValue((String) "Total Order");
        cell = row.createCell(colNum++);
        cell.setCellValue((Integer) or.size());
        row = sheet.createRow(rowNum++);
        colNum = 1;
        cell = row.createCell(colNum++);
        cell.setCellValue((String) "Total Revuene");
        cell = row.createCell(colNum++);
