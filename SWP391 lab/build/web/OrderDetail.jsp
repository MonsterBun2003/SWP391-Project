                        ...
                        <c:if test="${order.status==0}">
                            <div style="text-align: center" >
                                <form action="OrderPage" method="post">
                                    ...
                                    <input type="submit" name="order" value="Cancel" class="btn btn-danger">            
                                </form>
                            </div>
                        </c:if>
                    </div>
                        ...
                        <form action="OrderDetail" method="post">
                            ...
                            <div class="row">
                                <div class="col-5" style="padding: 7px;">
                                    <a href="OrderPage" style="font-size: 15px;margin-left: 10px" ><i class="fa fa-angle-double-left"></i> quay lại đơn hàng </a><!-- End .summary-title -->
                                </div>
                                <c:if test="${order.status==0}">
                                    <div class="col-7">
                                        <input type="submit" name="order" value="Change" style="font-size: 15px;background-color: #177bb6; color: white; border: none; padding: 7px; border-radius: 7px">            
                                    </div>
                                </c:if>
                            </div>
                        </form>
