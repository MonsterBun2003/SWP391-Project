                                        ...
                                        <form action="ManagerOrderDetail" method="post">
                                            ...
                                            <c:choose>
                                                <c:when test="${order.status==0}">
                                                    <input type="submit" name="corder" value="Cancel" class="btn btn-danger">            
                                                    <input type="submit" id="conorder" name="conorder" value="Confirm" class="btn btn-primary" disabled>            
                                                </c:when>
                                                <c:when test="${order.status==1}">
                                                    <input type="button" id="myButton" value="Add Service Tag" class="btn btn-danger" data-toggle="modal" data-target="#myModal" disabled>            
                                                    <input type="submit" id="shipping" name="sorder" value="Shipping" class="btn btn-primary" disabled>            
                                                </c:when>
                                                <c:when test="${order.status==2}">
                                                    <input type="button" name="rorder" value="Return" class="btn btn-danger" data-toggle="modal" data-target="#myModal1">            
                                                    <input type="submit" id="comorder" name="comorder" value="Complete" class="btn btn-primary" disabled="">            
                                                ...
                                                <c:when test="${order.status==3}">
                                                    <input type="submit"  value="Completed" class="btn btn-success" disabled="">            
                                                </c:when>
                                                <c:when test="${order.status==4}">
                                                    <input type="submit"  value="Cancelled" class="btn btn-danger" disabled="">            
                                                </c:when>
                                                <c:when test="${order.status==5}">
                                                    <input type="submit"  value="Returned" class="btn btn-danger" disabled="">            
                                                </c:when>
                                            </c:choose>
                                        </form>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered mo">
                                                ...
                                                <div class="modal-content">
                                                    <form action="ManagerOrderDetail" method="get" onsubmit="return validateForm(this)">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Thêm thẻ dịch vụ</h4>
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button"  class="btn btn-danger" data-dismiss="modal">Đóng</button>
                                                            <input type="submit" name="addtag" value="Add" class="btn btn-success">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
