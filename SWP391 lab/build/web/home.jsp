...
<html lang="en">
    ...
    <!--Start of Fchat.vn--><script type="text/javascript" src="https://cdn.fchat.vn/assets/embed/webchat.js?id=65a89a021300d05b4f53d655" async="async"></script><!--End of Fchat.vn-->
    <body>
        ...
        <script>
            function dieuHuong() {
                ...
                location.assign("http://localhost:9999/DAPMLPhoneStore/Product");
            }
        </script>
    </body>
</html>
