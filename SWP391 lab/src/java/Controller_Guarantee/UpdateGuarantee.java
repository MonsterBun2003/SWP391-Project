...
public class UpdateGuarantee extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (type != null) {
            ...
            if (!type.equals("Error due to manufacturer")) {
                Cart cart = (Cart) session.getAttribute("cartguarantee");
                Shipment ship = new Shipment(0, 0, "DH FPT, Xã Tân Xã, Huyện Thạch Thất, Thành phố Hà Nội", null, null, "0379522545", "DAPMLPhoneStore", "Pay For Guarantee Order");
                if (cart != null) {
