...
public class ManagerExportPdf extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            document.open();
            document.add(new Paragraph("DAPML Phone Store", new Font(baseFont, 15)));
            document.add(new Paragraph("\n", new Font(baseFont, 8))); // Create a table with 3 columns
            PdfPTable table = new PdfPTable(2);
            table.setWidthPercentage(100);
            table.addCell(createCell("Order ID: " + or.getOrder_id() + "", false, 9));
            table.addCell(createCell("Order Date:" + or.getOrder_date().toString() + "", false, 9));
            document.add(table);
            document.add(new Paragraph("\n", new Font(baseFont, 8)));
            ...
            table.setWidthPercentage(100);
            table.addCell(createCell("Shop Information", false, 10));
            table.addCell(createCell("Ship Information", false, 10));
            document.add(table);
            document.add(new Paragraph("\n", new Font(baseFont, 8)));
            table = new PdfPTable(2);
            table.setWidthPercentage(100);
            table.addCell(createCell("Shop: DAPML Phone Store ", false, 8));
            table.addCell(createCell("Name:" + ship.getName() + "", false, 8));
            table.addCell(createCell("Address: DH FPT, Thach That, Ha Noi", false, 8));
            table.addCell(createCell("Address:" + ship.getAddress() + " ", false, 8));
            table.addCell(createCell("Hotline: 0379522545", false, 8));
            table.addCell(createCell("Phone:" + ship.getPhone() + " ", false, 8));
            document.add(table);
            document.add(new Paragraph("\n", new Font(baseFont, 8)));
            table = new PdfPTable(1);
            table.setWidthPercentage(100);
            ...
            table.setWidthPercentage(100);
            table.addCell(createCell("Product", false, 9));
            table.addCell(createCell("Price", false, 9));
            table.addCell(createCell("Quantity", false, 9));
            document.add(table);
            table = new PdfPTable(1);
            table.setWidthPercentage(100);
            table.addCell(new PdfPCell());
            ...
            table = new PdfPTable(2);
            table.setWidthPercentage(100);
            table.addCell(createCell("Total: ", false, 9));
            ...
            table = new PdfPTable(2);
            table.setWidthPercentage(100);
            table.addCell(createCell("Note: ", false, 9));
            table.addCell(createCell(ship.getNote(), false, 9));
            document.add(table);
            table = new PdfPTable(1);
            table.setWidthPercentage(100);
            table.addCell(createCell("-Please take a video when receiving the product.", false, 8));
            table.addCell(createCell("-You receive the product, check and then pay the delivery staff.", false, 8));
            document.add(table);
            document.close();
